...
#define MIN_PITCH -0.40f
#define MAX_PITCH 0.27f
//pitch 速度环 PID参数以及 PID最大输出，积分输出
#define PITCH_SPEED_PID_KP 1.0f
#define PITCH_SPEED_PID_KI 0.03f
